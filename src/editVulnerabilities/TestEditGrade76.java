...
public class TestEditGrade76 {
	...
	public void test() {
		...
		tester.assertLinkNotPresentWithExactText("malicious delete");
		...
		utl.addSubmitButton("//form[@name='editgrade']");
		tester.submit();
		tester.assertMatch("Edit Grade");
		
		tester.assertLinkNotPresentWithExactText("malicious assignment");
