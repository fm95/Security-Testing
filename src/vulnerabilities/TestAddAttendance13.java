...
public class TestAddAttendance13 {
	...
	public void test() {
		...
		tester.setTextField("semester", "1'><a href=\"https://unitn.it\">malicious semester</a><br");
		tester.setTextField("student", "2'> <a href=\"https://www.unitn.it\">malicious student</a><br");
		tester.setTextField("page2", "31'> <a href=\"https://www.unitn.it\">malicious page2</a><br'");
